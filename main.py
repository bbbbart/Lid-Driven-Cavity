...
quiv = ax.quiver(x[::5], y[::5], u[::5, ::5], v[::5, ::5], scale=25)
...
def updateGrid(frame):
    ...
    for i in range(150):
        ...
        for i in range(max_i):
            ...
            ghost_p[[0,-1], 1:-1] =  p_old[[0, -1], :]
            ghost_p[1:-1, [0, -1]] = p_old[:, [0, -1]]
            ghost_p[1:-1, 1:-1] = p_old
            ...
            p = (up_p + down_p + left_p + right_p - (h**2)*b)/4 ## pressure solver
